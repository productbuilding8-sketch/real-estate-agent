    ...
    <div className="space-y-3">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-lg border border-gray-200 bg-white shadow-card py-2 pl-9 pr-9 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition-shadow"
        />
        {inputValue && (
          <button
      ...
      <div className="flex items-center gap-1.5 flex-wrap">
        {tabs.map((value) => {
          ...
          return (
            ...
            >
              {value === "all" ? "All leads" : <StatusBadge status={value} />}
              <span
                className={cn(
